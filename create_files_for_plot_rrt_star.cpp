...
int main(int argc, char ** argv){
    Env environment = Env(-3, 3, -1, 8, 0, 3, 0.25, 0.25, 0.099); // (x_min, x_max, y_min, y_max, z_min, z_max, delta_x, delta_y, delta_z) ... delta étant les marges autorisés au bords des obstacles
